...
public class StringFormat {
    ...
    public void test1() {
        ...
        String str1 = String.format("3>7的结果是：%b %n", 3 > 7); // 格式化字符串
        String str2 = String.format("100的一半是：%d %n", 100 / 2); // 格式化字符串
        String str3 = String.format("50元的书打8.5折扣是：%f 元%n", 50 * 0.85); // 格式化字符串
        String str4 = String.format("上面的折扣是%d %n", 85); // 格式化字符串
    ...
    public void test2() {
        ...
        String str = String.format("全部日期和时间信息：%tc", date); // 格式化字符串
        String str1 = String.format("年-月-日格式：%tF%n", date); // 格式化字符串
        String str2 = String.format("月/日/年格式：%tD%n", date); // 格式化字符串
        String str3 = String.format("HH:MM:SS PM格式(12时制)：%tr%n", date); // 格式化字符串
        String str4 = String.format("HH:MM:SS格式(24时制)：%tT%n", date);
        String str5 = String.format("HH:MM格式(24时制)：%tR%n", date);
        System.out.println(str);// 格式化输出日期或时间
